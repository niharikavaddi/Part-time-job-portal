# Generated by Django 4.1.2 on 2022-11-11 07:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(choices=[('Ottawa', 'Ottawa'), ('Toronto', 'Toronto'), ('Remote', 'Remote')], max_length=50)),
                ('description', models.TextField(blank=True)),
                ('about', models.TextField(blank=True)),
                ('job_date', models.DateTimeField(blank=True, default=datetime.datetime.now)),
                ('contract', models.CharField(choices=[('Part Time', 'Part Time'), ('Freelance', 'Freelancer')], max_length=150)),
